...
namespace new_test_project
{
    ...
    public class ApiTest : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Execute API test 'slTest'")]
        public void ApiTest_CodedStep()
        {
            // Execute API test 'slTest'
            ...
            this.ExecuteApiTest(".\\slTest", variables);
          //  Console.Write("anmol");
