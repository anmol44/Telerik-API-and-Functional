...
namespace new_test_project
{
    ...
    public class CreationForm : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Enter text '092410000' in 'EstablishmentIdentifierText'")]
        public void CreationForm_CodedStep()
        {
            // Enter text '092410000' in 'EstablishmentIdentifierText'
            String supplier = supplierIdGenerator().ToString();
            Actions.SetText(Pages.CreationRequestSupplier0.EstablishmentIdentifierText, supplier);
