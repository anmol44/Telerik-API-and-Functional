...
namespace new_test_project
{
    ...
    public class LoginAgain : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Navigate to : 'https://arc.sd.is.ssg/LoginAsUser'")]
        public void LoginAgain_CodedStep()
        {
            // Navigate to : 'https://arc.sd.is.ssg/LoginAsUser'
