...
namespace APIAutomation
{
    ...
    {				
		public void TestMethod()
		{
			...
			this.Log.WriteLine(this.Context.GetValue("lastname").ToString());
		...
		public void ResultToExcel(){	
			...
			// date and time when the file created
		...
		//	this.Log.WriteLine(errors);	
		    CreateCSV.addrecord(row,id,result,responseTime,statusCode,code,errors,env,vers,"avg","max","min","mode","min",path.ToString()+fileName.ToString()+dateandtime+".csv");
			this.Log.WriteLine(errors);
		}
